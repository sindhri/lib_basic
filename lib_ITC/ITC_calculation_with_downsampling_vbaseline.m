...
%20180630, added downsampling to a target frequency and variable baseline
function ITC_struct = ITC_calculation_with_downsampling_vbaseline(alleeg,...
    chan_list,freq_limits,target_srate,vbaseline)
...
if EEG.srate > target_srate
    EEG = ITC_downsampling_EEG(EEG,target_srate);
end
etimes = EEG.times;
