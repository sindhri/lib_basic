...
function ITC_struct = ITC_calculation_more_frequencies(alleeg, group_name, chan_list)
...
[freqs, nfreqs, ntimes, ~] = ITC_config(etimes);%not use the calculation_time_range
...
for i = 1:nsubjs
    ...
    [~, ~, ~, calculation_time_range] = ITC_config(etimes);
