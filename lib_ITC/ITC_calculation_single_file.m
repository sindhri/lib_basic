...
%20160907, changed n_freqs to nfreqs


function ITC_calculation_single_file(EEG,freq_limits,foldername)
...
all_ERSP = zeros(nfreqs, n_times, nconds, nbchan);
all_ITC_z = zeros(nfreqs, n_times, nconds, nbchan);
