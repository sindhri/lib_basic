...
function doi = ITC_create_doi(IE_struct,...
    poi, IE_type, export_text)


doi_mean = get_doi(IE_struct,poi,IE_type,'mean');
doi_max = get_doi(IE_struct,poi,IE_type,'max');
...
function doi = get_doi(IE_struct,poi,IE_type,result_type)
