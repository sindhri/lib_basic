...
function report = do_cond_rating_fdr_2016(data, rating, data_id, ...
    rating_id, subject_list, dependency,channel_list,alleeg)


baseline = alleeg.baseline/(1000/alleeg.srate);
...
data = data(channel_list, baseline+1 : ndatapoint,:);
