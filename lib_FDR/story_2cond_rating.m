%20190227, compare two conditions and their correlation with a rating
%input data, chan x time x subj, for one condition,
%each data (data_ave1, data_ave2) is a condition
...
function [data_plot1,data_2d1,data_signature1,...
    data_plot2,data_2d2, data_signature2] = story_2cond_rating(data_ave1,...
    data_ave2,poi,to_plot,rating_struct,rating_name)
