...
function [data_plot1,data_2d1,data_signature1,...
    data_plot2,data_2d2, data_signature2] = story_groupcompare(data_ave1,...
    data_ave2,poi,to_plot,conditions_to_compare)
...
measure2 = data_signature1.data(:,conditions_to_compare(2),1);
id2 = data_signature1.id;
do_conddiff_single(measure1,measure2,id1,id2);

measure1 = data_signature2.data(:,conditions_to_compare(1),1);
id1 = data_signature2.id;
...
id1 = data_signature1.id;
measure2 = data_signature1.data(:,conditions_to_compare(2),2);
id2 = data_signature1.id;
do_conddiff_single(measure1,measure2,id1,id2);

measure1 = data_signature2.data(:,conditions_to_compare(1),2);
id1 = data_signature2.id;
