...
%20130128
%changed pca start time from 0 to arbitary "startime"
%starttime is in terms of time, for example, startime = -1000 ms
%usually you calculate it before putting it in the function

function [factor_time,factor_time_peak,filename,...
    factor_index_in_times] = analyze_rotatedmatrix_tpca_with_times_starttime(factorResults,times,starttime,threshold)
...
time_zero = find(times==starttime)-1;
